...
// To run standalone: node db/migrate.js (requires top-level await compat or wrapper)
  ...
  await db.batch([
    {
      ...
      sql: `CREATE TABLE IF NOT EXISTS power_tasks (
    ...
    },
    {
      ...
      sql: `CREATE TABLE IF NOT EXISTS tomorrow_plan (
        id            INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    },
    {
      ...
      sql: `CREATE TABLE IF NOT EXISTS sql_practice (
        id              INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    },
    {
      ...
      sql: `CREATE TABLE IF NOT EXISTS gym_log (
        id                INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    },
    {
      ...
      sql: `CREATE TABLE IF NOT EXISTS relationship_checkins (
        id            INTEGER PRIMARY KEY AUTOINCREMENT,
